...
def encode_n_gram(symbol_space, n_gram):
    ...
    # return the product of all vectors in "mult", which will be its final element
    return mult[-1]
...
# TODO: sum_vec returns [[...]]: change to [...]
# sums vectors in a given list in columnar fashion
